...
executor.execute_epigenomic_experiment(data_retrieval, DataRetrieval.KEY_PROMOTERS)

executor.execute_epigenomic_experiment(data_retrieval, DataRetrieval.KEY_ENHANCERS)
